...
### Option 2: GitHub Raw
Replace `USERNAME` in `Loader.lua` with your GitHub username, then use:

```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/USERNAME/NMHub/main/Loader.lua"))()
```
